...
@section('content')
        ...
        @endif
        @if ($success === "0")
         <div class="alert alert-danger">"Modification échouée !"</div>
        @endif
    ...
    <div class="d-flex gap-3">
        ...
        <div>
            ...
            <div class="mt-3">
                <a href="{{ route('backoffice.products.edit', [$product->id]) }}" class="btn btn-danger btn-lg"
                    type="button" value="Editer">Editer</a>
            </div>
        </div>
    </div>
    <div class="mt-3">
